  ...
  return (
    <div style={containerStyle}>
      ...
      >
        ...
        <a
          href="https://youtube.com/@therohitmathur"
          target="_blank"
          rel="noreferrer"
          style={{
            ...socialBtnStyle,
        ...
        <a
          href="https://instagram.com/therohitmathur"
          target="_blank"
          rel="noreferrer"
          style={{
            ...socialBtnStyle,
        ...
        <a
          href="https://www.linkedin.com/in/therohitmathur"
          target="_blank"
          rel="noreferrer"
          style={{
            ...socialBtnStyle,
        ...
        <a
          href="https://x.com/therohitmathur"
          target="_blank"
          rel="noreferrer"
          style={socialBtnStyle}
        >
        ...
        <a
          href="https://linktr.ee/therohitmathur"
          target="_blank"
          rel="noreferrer"
          style={socialBtnStyle}
        >
